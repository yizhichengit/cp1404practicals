...
print(f"{1} {0} for about: ${3}".format(name, year))
...
output = f"{year} {name}  for about ${cost:,}!"
print(output)
...
# Iterate through the range and print formatted output
for num in range(start, end, step):
    formatted_num = f"{num:3}"  # Right-align the number with a width of 3
    print(formatted_num)
